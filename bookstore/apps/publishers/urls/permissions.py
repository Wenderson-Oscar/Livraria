...
from bookstore.apps.publishers.views.permissions import AddUserGroup, RemoveUserGroup, UpdateNameGroup, AddAdminGroup, RemoveAdminGroup
...
urlpatterns = [
    ...
    path('remove_user_group/<int:pk>/', RemoveUserGroup.as_view(), name='remove_user_group'),
